...
class ProductManagement(CommonFunction):
    ...
    def SpuManagement(self, JycList):
        ...
        assert res['retData'][0]['productNameFinal'] == JycList['brandName'] + ' ' + JycList['productName'], 'SPU管理修改基本信息, 商品名称不对\nspu:{},exp:{}, fact:{}'.format(JycList['spuNo'], JycList['brandName'] + ' ' + JycList['productName'], res['retData'][0]['productNameFinal'])
