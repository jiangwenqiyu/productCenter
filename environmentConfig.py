...
class Env():
    ...
    # cityPrice地址
    t4_cityPrice = 'http://product.t4.xinfangsheng.com'
    fangzhen_cityPrice = 'http://productservice.pre.xinfangsheng.com'
    shengchan_cityPrice = 'http://productservice.xinfangsheng.com'
    cityPrice = ''
